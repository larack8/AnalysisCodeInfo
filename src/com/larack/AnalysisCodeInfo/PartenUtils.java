...
public class PartenUtils {
	 ...
	 * WXSS属性正则
	 */
	public static final String PARTEN_WXSS_PROPERTY_SHOW = "[A-Za-z0-9\\-]+";
...
//	public static final String PARTEN_WXSS_PROPERTY = "[\\s]+[a-zA-Z\\-']+:[\\s]+[A-Za-z0-9\\-]+[;]";
	...
	public static final String PARTEN_TEL_PHONE = "(d+-)?(d{4}-?d{7}|d{3}-?d{8}|d{7,8})(-d+)?"; // 座机号码

	public static final String PARTEN_CEL_PHONE = "(13[0-9]|14[579]|15[0-3,5-9]|16[6]|17[0135678]|18[0-9]|19[89])\\d{8}"; // 手机号码

	public static final String PARTEN_IP_ADDRESS = "([1-9]|[1-9]\\d|1\\d{2}|2[0-4]\\d|25[0-5])(\\.(\\d|[1-9]\\d|1\\d{2}|2[0-4]\\d|25[0-5])){3}"; // IP地址
